(ns marketentry.registry
  ...
  call to any real government-tenders portal. It builds the RECORD
...
(defn register-draft
  ...
  market-entry operator's own act of preparing a government-tender
...
(defn register-submit
  ...
  government-tender filing (always human-gated upstream)."
  [engagement-id jurisdiction sequence]
  (when-not (and engagement-id (not= engagement-id ""))
